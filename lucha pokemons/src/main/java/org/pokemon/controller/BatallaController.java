...
public class BatallaController {
    ...
    public void initialize(CampoDeBatalla campoDeBatalla) {
        ...
        mensaje += pokemonAfectaClima(campo, pokemonAtacante);
    ...
    private void seleccionarHabilidad(ActionEvent actionEvent) {
        ...
        if (!this.campo.getPokemonAtacante().puedePelear()){
            ...
            animacionTexto(pokemonEstadoTexto(this.campo.getPokemonAtacante()), this.texto);
            cambiarTurno();
            return;
        }
    ...
    private String pokemonAfectaClima(CampoDeBatalla campo, Pokemon pokemon) {
        String mensaje = "";
    ...
    private String pokemonEstadoTexto(Pokemon pokemon) {
        ...
        for (ConstantesModelo.Estados estado : pokemon.getEstados()) {
            if (estado == ConstantesModelo.Estados.ENVENENADO) {
                 mensaje +=  "esta ENVENENADO y recibe daño\n";
